...
public class MyListView extends ListView {
    ...
    private void scrollRight() {
        ...
        Log.e("Right.getScrollX()","ScrollX"+itemView.getScrollX());
        Log.e("Right.getScrollY()","ScrollY"+itemView.getScrollY());
    ...
    private void scrollLeft() {
        ...
        final int delta = (screenWidth - itemView.getScrollX());
        Log.e("Left.getScrollX()","ScrollX"+itemView.getScrollX());
        Log.e("Left.getScrollY()","ScrollY"+itemView.getScrollY());
        // 调用startScroll方法来设置一些滚动的参数，我们在computeScroll()方法中调用scrollTo来滚动item
        scroller.startScroll(itemView.getScrollX(), 0, delta, 0,
                Math.abs(delta));
        postInvalidate(); // 刷新itemView
        ...
        if (isSlide && slidePosition != AdapterView.INVALID_POSITION) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    Log.e("ACTION_MOVE)","downX"+downX+" x"+x);
                    Log.e("ACTION_MOVE----","downY"+downY);
